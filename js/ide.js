...
var ide = new function () {
    ...
    function getCurrentPsn(callback) {
    ...
    function initAfterI18n() {
       ...
       // );
        ...
        overpass.handlers["onDataRecieved"] = function (amount,
                                                        amount_txt,
                                                        abortCB,
                                                        continueCB) {
            if (amount > 1000000) {
    ...
    this.onKeyPress = function (event) {
        ...
        if (
            ...
            (event.ctrlKey || event.metaKey) && !event.shiftKey && !event.altKey) || // Ctrl+I
